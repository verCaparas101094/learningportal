...
{
    /// <inheritdoc />
    public partial class AddEnrollmentAndStudentCatalog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_EnrolledAtUtc",
                table: "Enrollments",
                column: "EnrolledAtUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Enrollments_CourseId_StudentId_Active",
                table: "Enrollments",
                columns: new[] { "CourseId", "StudentId" },
                unique: true,
                filter: "[Status] <> N'Withdrawn'");
        }
